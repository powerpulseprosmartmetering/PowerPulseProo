...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://powerpulseprosmartmetering_db_user:xnghvgZFup00yCNV@powerpulsepro.bsmvihg.mongodb.net/?appName=PowerPulsePro')
  .then(async () => {
